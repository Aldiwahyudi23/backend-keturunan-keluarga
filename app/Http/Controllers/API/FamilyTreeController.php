...
use App\Services\Card\CardEmergencyService;
...
class FamilyTreeController extends Controller
{
    public function __construct(
        ...
        protected CardEmergencyService $cardEmergencyService
    ) {}
    ...
    public function getFamilyTree(Request $request, string $identifier): JsonResponse
    {
        try {
            ...
            $cardUuid = $request->query('card');

            if ($cardUuid) {
                $tree['card_emergency'] = $this->cardEmergencyService->getEmergencyData(
                    $identifier,
                    $cardUuid
                );
            }
